...
if ([string]::IsNullOrWhiteSpace($OutputDir)) {
    $OutputDir = Join-Path $rootDir "dist/SimplyTransfer-Release"
}
...
$solutionPath = Join-Path $rootDir "SimplyTransfer.sln"
$projectPath = Join-Path $rootDir "SimplyTransfer.UI/SimplyTransfer.UI.csproj"
...
$zipPath = Join-Path $rootDir "SimplyTransfer-Windows-x64-v$appVersion.zip"
